const products = [
    ...
    { name: 'ESENSE NEW SIZE 20ML', image: 'ess.png', price: 500000, description: 'New Product!! Esense dari MCI adalah essential oil yang dihasilkan dari berbagai bagian dari tumbuhan seperti batang, daun, bunga, buah, biji, kulit, dan sebagainya. Esense dari MCI dengan kualitas terbaik,yang dapat digunakan sebagai parfum, kosmetik, antibiotik, antioksidan, imunostimulan, mengurangi stress, dan terapi untuk berbagai penyakit ringan.' },
];
